...
function WorkExperienceItem({
  ...
  return (
    <div
      className={cn("space-y-3 rounded-md border bg-background p-3", isDragging && 'shadow-xl z-50')}
      ref={setNodeRef}
      style={{
    ...
    >
      ...
      <FormDescription>
        leave <span className="font-semibold43">end date</span> empty if you are
        currently here
      </FormDescription>
      <FormField
        control={form.control}
