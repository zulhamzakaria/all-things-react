    ...
    <section className="mt-16 w-full max-w-xl">
      <div className="flex = flex-col w-full gap-2">
        <form className="relative flex justify-center items-center" onSubmit={handleSubmit}>
          ...
          <button type="submit" className="submit_btn peer-focus:border-gray-70 peer-focus:text-gray-700">🔍</button>
        </form>
        {/* url history */}
      ...
      <div className='my-10 max-w-full justify-center items-center'>
        {isFetching ? 
          (<img src={loader} alt="loader" className='w-10 h-10'/>): 
            error ? 
              (<p className='font-inter font-bold text-black text-center'>somns wrong...<br/>
